...
setuptools.setup(
    ...
    install_requires=['websockets>=5,<8', 'paho-mqtt', 'simple-conf-manager'],
    dependency_links=['git+https://github.com/y-du/simple-conf-manager.git#egg=simple-conf-manager'],
