...
class TestDevice(DeviceType):
    ...
    @service(input=setColorInput, output=setColorOutput)
    ...
    @service(input=setBrightnessInput, output=setBrightnessOutput)
    def setBrightness(self, brightness):
        return brightness


d = TestDevice("device#id", "device#name")
print(d)